...
public interface S7PlcMessages {
    ...
    @En("BOOL")
    public String s7TypeBool();

    @En("BYTE")
    public String s7TypeByte();

    @En("WORD")
    public String s7TypeWord();

    @En("DWORD")
    public String s7TypeDWord();

    @En("INT")
    public String s7TypeInt();

    @En("DINT")
    public String s7TypeDInt();

    @En("REAL")
    public String s7TypeReal();

    @En("CHAR")
    public String s7TypeChar();

    @En("step7 data type")
    public String s7DataType();
